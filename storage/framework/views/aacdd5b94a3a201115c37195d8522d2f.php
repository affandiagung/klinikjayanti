    ...
    <div class="row">
      ...
      <div class="row-6">
        <table class="table">
          ...
          <?php $__currentLoopData = $daftar_dokter; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dokter): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <tr>
            <th><?php echo e($dokter->id); ?></th>
            <th><?php echo e($dokter->nama); ?></th>
            <th><?php echo e($dokter->email); ?></th>
            <th><?php echo e($dokter->alamat); ?></th>
            <th><?php echo e($dokter->phone); ?></th>
            <th><?php echo e($dokter->foto); ?></th>
          </tr>
...
</html><?php /**PATH E:\Laravel\DokterGigi\resources\views/dokter/index.blade.php ENDPATH**/ ?>